        ...
        resources: {
            en: {
                translation: {
                    ...
                    exploreOurPremiumServices: "Explore our premium automotive services through detailed photos of our work and facilities",
                    ...
                    noServicesDescription: "We couldn't find any services matching your search criteria. Try adjusting your filters or search terms.",
                    resetFilters: "Reset Filters",
                    readyToService: "Ready to Service Your Vehicle?",
                    scheduleService: "Schedule Service",
                    viewAllServices: "View All Services",
                    bookThisService: "Book This Service",
                    completeEngineRebuild: "Complete engine rebuild and performance optimization",
                    highPerformanceBrake: "High-performance brake pad and rotor replacement",
                    fullSyntheticOil: "Full synthetic oil change with filter replacement",
                    advancedComputerAnalysis: "Advanced computer system analysis and troubleshooting",
                    specializedLuxuryCare: "Specialized care for premium and luxury vehicles",
                    transmissionMaintenance: "Automatic and manual transmission maintenance",
                    electricalSystemRepair: "Complete electrical system diagnostics and repair",
                    performanceOptimization: "Engine performance optimization and tuning",
                    acSystemMaintenance: "Air conditioning system maintenance and repair",
                    engineOverhaulService: "Engine Overhaul Service",
                    premiumBrakeSystem: "Premium Brake System",
                    oilChangeService: "Oil Change Service",
                    computerDiagnostics: "Computer Diagnostics",
                    luxuryVehicleService: "Luxury Vehicle Service",
                    transmissionService: "Transmission Service",
                    electricalSystem: "Electrical System Repair",
                    performanceTuning: "Performance Tuning",
                    acSystemService: "AC System Service",
                    galleryDescription: "See something you like? Schedule your service appointment today and experience the Ajal Garage difference.",
                    engine: "Engine",
            ...
            ar: {
                translation: {
                    ...
                    // Add to ar.translation object
                    ourServiceGallery: "معرض خدماتنا",
                    exploreOurPremiumServices: "استكشف خدماتنا المميزة للسيارات من خلال الصور التفصيلية لأعمالنا ومرافقنا",
                    searchServices: "ابحث في الخدمات...",
                    showingResults: "عرض {{count}} من أصل {{total}} خدمة",
                    ...
                    noServicesDescription: "لم نتمكن من العثور على أي خدمات تطابق معايير البحث الخاصة بك. حاول تعديل عوامل التصفية أو مصطلحات البحث.",
                    resetFilters: "إعادة تعيين الفلاتر",
                    readyToService: "مستعد لخدمة سيارتك؟",
                    scheduleService: "جدولة الخدمة",
                    viewAllServices: "عرض جميع الخدمات",
                    bookThisService: "احجز هذه الخدمة",
                    completeEngineRebuild: "إعادة بناء محرك كاملة وتحسين الأداء",
                    highPerformanceBrake: "استبدال وسادات وأقراص فرامل عالية الأداء",
                    fullSyntheticOil: "تغيير زيت اصطناعي كامل مع استبدال الفلتر",
                    advancedComputerAnalysis: "تحليل متقدم لنظام الكمبيوتر واستكشاف الأخطاء وإصلاحها",
                    specializedLuxuryCare: "رعاية متخصصة للسيارات الفاخرة والمميزة",
                    transmissionMaintenance: "صيانة ناقل الحركة الأوتوماتيكي واليدوي",
                    electricalSystemRepair: "تشخيص وإصلاح كامل للنظام الكهربائي",
                    performanceOptimization: "تحسين أداء المحرك وضبطه",
                    acSystemMaintenance: "صيانة وإصلاح نظام تكييف الهواء",
                    engineOverhaulService: "خدمة إصلاح المحرك الشامل",
                    premiumBrakeSystem: "نظام فرامل مميز",
                    oilChangeService: "خدمة تغيير الزيت",
                    computerDiagnostics: "تشخيص الكمبيوتر",
                    luxuryVehicleService: "خدمة المركبات الفاخرة",
                    transmissionService: "خدمة ناقل الحركة",
                    electricalSystem: "إصلاح النظام الكهربائي",
                    performanceTuning: "ضبط الأداء",
                    acSystemService: "خدمة نظام التكييف",
                    galleryDescription: "هل رأيت شيئًا يعجبك؟ قم بجدولة موعد الخدمة اليوم وجرب فرق آجل جاراج.",
                    engine: "المحرك",
                    performance: "الأداء",
                    repair: "الإصلاح",
                    brakes: "الفرامل",
            ...
            ur: {
                translation: {
                    ...
                    // Add to ur.translation object
                    ourServiceGallery: "ہماری سروس گیلری",
                    exploreOurPremiumServices: "ہمارے کام اور سہولیات کی تفصیلی تصاویر کے ذریعے ہماری پریمیم آٹوموٹو سروسز دریافت کریں",
                    searchServices: "سروسز تلاش کریں...",
                    showingResults: "{{total}} میں سے {{count}} سروسز دکھا رہے ہیں",
                    allServices: "تمام سروسز",
                    engineRepair: "انجن مرمت",
                    brakeService: "بریک سروس",
                    maintenance: "بحالی",
                    diagnostics: "تشخیص",
                    customWork: "کسٹم کام",
                    noServicesFound: "کوئی سروس نہیں ملی",
                    noServicesDescription: "ہمیں آپ کے سرچ معیار سے ملتی جلتی کوئی سروس نہیں مل سکی۔ اپنے فلٹرز یا سرچ کی شرحوں کو ایڈجسٹ کرنے کی کوشش کریں۔",
                    resetFilters: "فلٹرز ری سیٹ کریں",
                    readyToService: "اپنی گاڑی کی سروس کے لیے تیار ہیں؟",
                    scheduleService: "سروس شیڈول کریں",
                    viewAllServices: "تمام سروسز دیکھیں",
                    bookThisService: "یہ سروس بک کریں",
                    completeEngineRebuild: "مکمل انجن کی تعمیر نو اور کارکردگی کی بہتری",
                    highPerformanceBrake: "اعلیٰ کارکردگی بریک پیڈ اور روٹر تبدیلی",
                    fullSyntheticOil: "فلٹر تبدیلی کے ساتھ مکمل سنتھیٹک آئل چینج",
                    advancedComputerAnalysis: "ایڈوانسڈ کمپیوٹر سسٹم تجزیہ اور خرابیوں کا سراغ لگانا",
                    specializedLuxuryCare: "پریمیم اور لگژری گاڑیوں کے لیے خصوصی دیکھ بھال",
                    transmissionMaintenance: "آٹومیٹک اور مینوئل ٹرانسمیشن کی بحالی",
                    electricalSystemRepair: "مکمل الیکٹریکل سسٹم ڈائیگناسٹکس اور مرمت",
                    performanceOptimization: "انجن کارکردگی کی بہتری اور ٹیوننگ",
                    acSystemMaintenance: "ایئر کنڈیشنگ سسٹم کی بحالی اور مرمت",
                    engineOverhaulService: "انجن اوورہال سروس",
                    premiumBrakeSystem: "پریمیم بریک سسٹم",
                    oilChangeService: "آئل چینج سروس",
                    computerDiagnostics: "کمپیوٹر ڈائیگناسٹکس",
                    luxuryVehicleService: "لگژری وہیکل سروس",
                    transmissionService: "ٹرانسمیشن سروس",
                    electricalSystem: "الیکٹریکل سسٹم مرمت",
                    performanceTuning: "پرفارمنس ٹیوننگ",
                    acSystemService: "AC سسٹم سروس",
                    galleryDescription: "کیا آپ کو کچھ پسند آیا؟ اپنا سروس اپائنٹمنٹ آج ہی شیڈول کریں اور آجل گیراج کا فرق محسوس کریں۔",
                    engine: "انجن",
